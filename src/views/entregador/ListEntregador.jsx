                                    ...
                                    <Table.Row key={entregador.id}>
                                        ...
                                        <Table.Cell textAlign='center'>
                                            ...
                                            <Button
                                                ...
                                                circular
                                                color='blue'
                                                title='Clique aqui para ver todos os dados deste entregador'
                                                icon
                                                onClick={e => confirmaLista(entregador.id)}>
                                                <Link to="/form-entregador" state={{ id: entregador.id }} style={{ color: 'green' }}> <Icon name='eye' /> </Link>
                                            </Button>
